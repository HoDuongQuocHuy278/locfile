...
Hệ thống NOAH Retail Unified Commerce được thiết kế theo kiến trúc **Microservices**, chia thành **5 tầng** (Layers), chạy trên **Docker Compose** với 9 containers giao tiếp qua mạng nội bộ `noah-network`.
...
|---|---|---|
| **Presentation** | HTML, CSS, JavaScript, Chart.js, Inter Font | Dashboard UI (Light mode, responsive) |
